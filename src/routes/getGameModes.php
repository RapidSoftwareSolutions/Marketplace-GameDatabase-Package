...
$app->post('/api/GameDatabase/getGameModes', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['requestUrl','userKey','gameModeIds']);
    ...
    $requiredParams = ['requestUrl'=>'requestUrl','userKey'=>'userKey','gameModeIds'=>'gameModeIds'];
