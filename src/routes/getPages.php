...
$app->post('/api/GameDatabase/getPages', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['requestUrl','userKey','pageIds']);
    ...
    $requiredParams = ['requestUrl'=>'requestUrl','userKey'=>'userKey','pageIds'=>'pageIds'];
    ...
    $query_str = "{$data['requestUrl']}/pages/{$data['pageIds']}";
